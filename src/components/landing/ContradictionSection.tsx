...
const CONTRA_FRAMES = [
  '/assets/illustrations/frames/contra-frame-1.webp',
  '/assets/illustrations/frames/contra-frame-2.webp',
  '/assets/illustrations/frames/contra-frame-3.webp',
];
      ...
      <div className="container">
        ...
        <div className="section-with-illus">
          ...
          <div className="section-with-illus__visual">
            <FrameAnimation
              frames={CONTRA_FRAMES}
              active={visible}
              interval={1500}
              alt="Mâu thuẫn biện chứng"
            />
          </div>
        </div>

        {/* Comparison columns: full-width below */}
